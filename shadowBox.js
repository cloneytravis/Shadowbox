...
function render()
{
    ...
    mvMatrix = mat4( );
    mvMatrix = mult(mvMatrix, rotate(30.0, 0.0, 0.0, 0.0));
    mvMatrix = mult(mvMatrix, translate(0.0, 0.0, 0.0, 0.0));
    ...
    /*
    mvMatrix = mat4( );
    mvMatrix = mult(mvMatrix, rotate(30, 0.0, 0.0, 0.0));
